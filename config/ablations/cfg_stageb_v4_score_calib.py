...
# Stage-B v4: start from v2 checkpoint0003, use GroundingDINO-like all-query
# sigmoid focal text loss, and add inference-score calibration.
...
stage_b_text_loss_type = "allquery_focal"
stage_b_text_focal_alpha = 0.25
stage_b_text_focal_gamma = 2.0
# Dense all-query focal has many valid query-token negatives, so keep its
# weighted contribution near the old matched-BCE text term.
lambda_text = 0.05
