...
# D8 is initialized from the exact formal D1 U500 checkpoint, never D2-D7.
...
stage_b_native_patch_execution_scope = "native_patch_category_d8_u100_v1"
stage_b_native_patch_formal_config_path = (
    "/media/haoyi/T9/pivot/config/ablations/"
    "cfg_stageb_native_patch_category_d8_u100.py"
)
stage_b_native_patch_formal_output_dir = (
    "/media/haoyi/T9/pivot/outputs/paper_cvpr_v1/"
    "native_patch_category_d8_seed42_s43_b36a2_lr5e5_amp8_u100_v1"
)
