from config.ablations.cfg_stageb_native_patch_category_d2 import *  # noqa: F401,F403

# This parser-owned value is supplied explicitly by the formal command.
del gradient_accumulation_steps

# D2 is a fresh-optimizer continuation from the exact formal D1 U500 model.
...
stage_b_native_patch_execution_scope = "native_patch_category_d2_u500_v1"
stage_b_native_patch_formal_config_path = (
    "/media/haoyi/T9/pivot/config/ablations/"
    "cfg_stageb_native_patch_category_d2_u500.py"
)
stage_b_native_patch_formal_output_dir = (
    "/media/haoyi/T9/pivot/outputs/paper_cvpr_v1/"
    "native_patch_category_d2_seed42_b36a2_lr1e4_u500_v1"
)
