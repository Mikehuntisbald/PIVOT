from config.ablations.cfg_stageb_native_patch_category_d4 import *  # noqa: F401,F403

# This parser-owned value is supplied explicitly by the formal command.
del gradient_accumulation_steps

# D4 is initialized from the exact formal D1 U500 checkpoint, never D2/D3.
...
stage_b_native_patch_execution_scope = "native_patch_category_d4_u200_v1"
stage_b_native_patch_formal_config_path = (
    "/media/haoyi/T9/pivot/config/ablations/"
    "cfg_stageb_native_patch_category_d4_u200.py"
)
stage_b_native_patch_formal_output_dir = (
    "/media/haoyi/T9/pivot/outputs/paper_cvpr_v1/"
    "native_patch_category_d4_seed42_s43_b36a2_lr5e5_amp8_u200_v1"
)
