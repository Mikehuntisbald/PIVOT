from config.ablations.cfg_stageb_native_patch_category_d9 import *  # noqa: F401,F403

# This parser-owned value is supplied explicitly by the formal command.
del gradient_accumulation_steps

# D9 restarts from the exact formal D1 U500 checkpoint, never D8.
...
stage_b_native_patch_formal_config_path = (
    ...
    "cfg_stageb_native_patch_category_d9_u100.py"
)
