from tools import (
    audit_stageb_confidence_adapter_veto_gated_pool_carrier_quarter_probe_health as health,
)
from tools import (
    run_stageb_confidence_adapter_veto_gated_pool_carrier_quarter_highmem_formal as formal,
)
from tools import (
    run_stageb_confidence_adapter_veto_gated_pool_carrier_quarter_probe as probe,
)
from tools import (
    run_stageb_confidence_adapter_veto_gated_pool_carrier_quarter_probe_evaluation as promotion,
)
from tools import (
    run_stageb_confidence_adapter_veto_gated_pool_carrier_quarter_probe_u0050 as probe_u0050,
)
...
def test_carrier_quarter_formal_contract_binds_v8_and_u6551(monkeypatch):
    monkeypatch.setattr(
        formal._BASE,
...
def test_carrier_quarter_probe_and_promotion_are_fresh_exact_contracts():
...
def test_carrier_quarter_health_preregisters_routing_and_attribution(monkeypatch):
    monkeypatch.setattr(
        health,
        "_BASE_HEALTH_CHECKS",
