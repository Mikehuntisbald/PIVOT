# Legacy Stage-A/B README snapshot

> **Historical pre-ARROW artifact.** This is the complete Stage-A/B and
> Open-GroundingDINO implementation section extracted from repository commit
> `b77c8fa45c5c5eae1566f1928805c4fd138af73a`. Names and commands are
> preserved for provenance; the current paper model is
> [ARROW-U2](../arrow_u2_model_card.md).

Relative file links and shell commands below were authored when this content
lived at the repository root; resolve them from the repository root when
replaying the historical workflow.
