...
"""Run the fresh U400 V60 deployment-owned query-veto probe."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_deployment_owned_query_veto_u0400_base",
    _BASE_PATH,
)
...
LOCK = OUTPUT.parent.parent / (
    ".confidence_adapter_deployment_owned_query_veto_u0400.lock"
)
