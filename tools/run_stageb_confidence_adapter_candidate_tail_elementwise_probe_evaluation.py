...
"""Run, audit, and promote the v38 U400 strict1607 probe."""
...
from tools import (  # noqa: E402
    run_stageb_confidence_adapter_candidate_tail_elementwise_probe_u0400 as training,
)

_BASE_PATH = REPO_ROOT / "tools/run_stageb_confidence_adapter_veto_probe_evaluation.py"
_BASE_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_candidate_tail_elementwise_probe_evaluation_base",
    _BASE_PATH,
)
...
_HEALTH_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_candidate_tail_elementwise_probe_health",
    _HEALTH_PATH,
)
...
CONFIG = REPO_ROOT / (
    ...
    "candidate_tail_elementwise_probe_u0400_20260801.py"
)
