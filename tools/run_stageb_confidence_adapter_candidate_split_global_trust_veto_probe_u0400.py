...
"""Run the fresh U400 split-global-trust/veto confidence probe."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_candidate_split_global_trust_veto_u0400_base",
    _BASE_PATH,
)
...
LOCK = OUTPUT.parent.parent / ".confidence_adapter_split_global_trust_veto_u0400.lock"
