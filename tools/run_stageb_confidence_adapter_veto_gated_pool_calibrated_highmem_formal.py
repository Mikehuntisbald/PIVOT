...
"""Fail-closed controller for calibrated carrier-gated formal training."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_veto_gated_pool_calibrated_formal_base",
    _BASE_PATH,
)
...
CONFIG = REPO_ROOT / "config/ablations/cfg_stageb_dense_duty_confidence_adapter_veto_gated_pool_calibrated_20260731.py"
OUTPUT = REPO_ROOT / "outputs/paper_cvpr_v1/dense_duty_adapter_veto_gated_pool_calibrated_highmem_20260731/formal/confidence"
CHECKPOINT = OUTPUT / "checkpoint_iter.pth"
LOCK = OUTPUT.parent.parent / ".formal_confidence_adapter_veto_gated_pool_calibrated.lock"
