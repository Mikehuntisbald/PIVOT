...
"""Run the fresh U400 V52 candidate/sample-calibrator confidence probe."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_candidate_sample_calibrator_u0400_base",
    _BASE_PATH,
)
...
LOCK = OUTPUT.parent.parent / ".confidence_adapter_candidate_sample_u0400.lock"
