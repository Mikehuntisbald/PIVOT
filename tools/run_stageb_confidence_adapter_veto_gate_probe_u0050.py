...
"""Run the U50 raw-gate-supervised word-veto trajectory screen."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_veto_gate_u0050_base", _BASE_PATH
)
...
CONFIG = (
    REPO_ROOT
    / "config/ablations/"
    "cfg_stageb_dense_duty_confidence_adapter_veto_gate_probe_u0050_20260731.py"
)
OUTPUT = (
    REPO_ROOT
    / "outputs/paper_cvpr_v1/"
    "dense_duty_adapter_veto_gate_highmem_20260731/probe/u000050"
)
CHECKPOINT = OUTPUT / "checkpoint_iter.pth"
LOCK = OUTPUT.parent.parent / ".confidence_adapter_veto_gate_u0050.lock"
