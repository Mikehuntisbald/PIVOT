...
"""Run and audit the v3 raw-gate word-veto U300 strict1607 diagnostic."""
...
from tools import (  # noqa: E402
    audit_stageb_confidence_adapter_veto_gate_probe_health as health,
)
from tools import run_stageb_confidence_adapter_veto_gate_probe as training  # noqa: E402


_BASE_PATH = REPO_ROOT / "tools/run_stageb_confidence_adapter_veto_probe_evaluation.py"
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_veto_gate_evaluation_base", _BASE_PATH
)
...
SCHEMA = "pivot.stageb.confidence_adapter_veto_gate_probe_evaluation/v3"
POSTFLIGHT_SCHEMA = (
    "pivot.stageb.confidence_adapter_veto_gate_probe_evaluation_postflight/v3"
)
ADMISSION_SCHEMA = "pivot.stageb.confidence_adapter_veto_gate_formal_admission/v3"
...
FORMAL_CONFIG = (
    REPO_ROOT
    / "config/ablations/"
    "cfg_stageb_dense_duty_confidence_adapter_veto_gate_20260731.py"
)
CHECKPOINT = (
    REPO_ROOT
...
OUTPUT = (
    REPO_ROOT
    / "outputs/paper_cvpr_v1/"
    "dense_duty_adapter_veto_gate_highmem_20260731/"
...
def verify_admission_report(report_path=None, *, health_audit=None):
    return _BASE.verify_admission_report(
        report_path, health_audit=health_audit
    )
