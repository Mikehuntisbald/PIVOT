...
"""Run the fresh U400 split confidence-head admission probe."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_candidate_split_heads_u0400_base",
    _BASE_PATH,
)
...
OUTPUT = REPO_ROOT / (
    ...
    "dense_duty_adapter_candidate_split_heads_highmem_20260801/"
    "probe/u000400_fresh"
)
CHECKPOINT = OUTPUT / "checkpoint_iter.pth"
LOCK = OUTPUT.parent.parent / ".confidence_adapter_candidate_split_heads_u0400.lock"
