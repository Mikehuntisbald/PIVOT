...
"""Run the U300 paired-carrier word-veto confidence probe."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_carrier_pair_probe_base", _BASE_PATH
)
...
OUTPUT = REPO_ROOT / "outputs/paper_cvpr_v1/dense_duty_adapter_veto_gated_pool_carrier_pair_highmem_20260731/probe/u000300"
CHECKPOINT = OUTPUT / "checkpoint_iter.pth"
LOCK = OUTPUT.parent.parent / ".confidence_adapter_carrier_pair_probe.lock"
