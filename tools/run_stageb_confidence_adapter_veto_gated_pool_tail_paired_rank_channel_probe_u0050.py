...
"""Run the independent U50 sparse rank-channel confidence screen."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_rank_channel_u0050_base", _BASE_PATH
)
...
LOCK = OUTPUT.parent.parent / ".confidence_adapter_rank_channel_u0050.lock"
