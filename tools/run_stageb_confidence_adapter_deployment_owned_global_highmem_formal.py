...
"""Run fresh V56 formal confidence training after strict1607 admission."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_deployment_owned_formal_base",
    _BASE_PATH,
)
...
LOCK = OUTPUT.parent.parent / ".formal_confidence_adapter_deployment_owned.lock"
