...
"""Run the fresh U400 V57 deployed-global balanced-absolute probe."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_deployed_global_balanced_absolute_u0400_base",
    _BASE_PATH,
)
...
LOCK = OUTPUT.parent.parent / (
    ".confidence_adapter_deployed_global_balanced_absolute_u0400.lock"
)
