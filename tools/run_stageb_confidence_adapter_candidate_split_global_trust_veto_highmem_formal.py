...
"""Run fresh V49 formal confidence training after strict1607 admission."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_candidate_split_global_trust_veto_formal_base",
    _BASE_PATH,
)
...
LOCK = OUTPUT.parent.parent / ".formal_confidence_adapter_split_global_trust_veto.lock"
