...
"""Run the fresh U600 convergence screen for the unchanged v29 adapter."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_candidate_absolute_u0600_base",
    _BASE_PATH,
)
...
CONFIG = REPO_ROOT / (
    ...
    "candidate_absolute_probe_u0600_20260731.py"
)
OUTPUT = REPO_ROOT / (
...
LOCK = OUTPUT.parent.parent / ".confidence_adapter_candidate_absolute_u0600.lock"
LOG = OUTPUT.parent / "u000600_fresh_controller.log"
UPDATES = 600
