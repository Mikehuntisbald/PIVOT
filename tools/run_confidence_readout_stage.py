...
def run(args):
    ...
    for seed, gpu in zip((17, 42, 73), args.gpus):
        ...
        commands[str(seed)] = [str(Path(sys.executable).absolute()), str(ROOT / "tools/train_confidence_readout_heads.py"),
    ...
    receipt = {"schema": "arrow.confidence_readout.stage_launch/v1", "protocol": bind(args.protocol),
...
if __name__ == "__main__":
    ...
    parser.add_argument("--localizer", choices=("mmgdino_positive", "mdetr_r101_refcoco_ema"), required=True)
