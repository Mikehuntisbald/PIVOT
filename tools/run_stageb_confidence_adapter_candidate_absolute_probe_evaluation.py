...
"""Run the v29 U300 strict1607 confidence diagnostic."""
...
from tools import run_stageb_confidence_adapter_candidate_absolute_probe_u0300 as training
...
CONFIG = REPO_ROOT / (
    ...
    "candidate_absolute_probe_u0300_20260731.py"
)
FORMAL_CONFIG = REPO_ROOT / (
    "config/ablations/"
    "cfg_stageb_dense_duty_confidence_adapter_candidate_absolute_20260731.py"
)
