...
"""Run the fresh U400 v41 role-complete carrier probe."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_role_complete_carrier_u0400_base",
    _BASE_PATH,
)
...
CONFIG = REPO_ROOT / (
    ...
    "role_complete_carrier_probe_u0400_20260801.py"
)
OUTPUT = REPO_ROOT / (
...
LOCK = OUTPUT.parent.parent / (
    ".confidence_adapter_candidate_role_complete_carrier_u0400.lock"
)
