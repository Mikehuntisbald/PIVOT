...
"""Run the U300 cross-attention absolute-confidence screen."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_cross_attention_absolute_u0300_base",
    _BASE_PATH,
)
...
LOCK = OUTPUT.parent.parent / (
    ".confidence_adapter_cross_attention_absolute_u0300.lock"
)
