...
"""Run the fresh U400 v43 deployed-veto routing admission probe."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_candidate_deployed_routing_u0400_base",
    _BASE_PATH,
)
...
LOCK = OUTPUT.parent.parent / (
    ".confidence_adapter_candidate_deployed_routing_u0400.lock"
)
