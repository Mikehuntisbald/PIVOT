...
"""Run the fresh U400 v31 normalized-patch admission probe."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_candidate_normalized_u0400_base",
    _BASE_PATH,
)
...
CONFIG = REPO_ROOT / (
    ...
    "candidate_normalized_probe_u0400_20260731.py"
)
OUTPUT = REPO_ROOT / (
...
LOCK = OUTPUT.parent.parent / ".confidence_adapter_candidate_normalized_u0400.lock"
