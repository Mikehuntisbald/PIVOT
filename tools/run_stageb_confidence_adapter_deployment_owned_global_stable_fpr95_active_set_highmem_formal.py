...
"""Run fresh V58 formal confidence training after strict1607 admission."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_deployment_owned_stable_fpr95_active_set_formal_base",
    _BASE_PATH,
)
...
OUTPUT = REPO_ROOT / (
    ...
    "highmem_20260802/formal/confidence"
)
CHECKPOINT = OUTPUT / "checkpoint_iter.pth"
LOCK = OUTPUT.parent.parent / (
    ".formal_confidence_adapter_deployment_owned_global_stable_fpr95_"
    "active_set.lock"
)
