...
"""Fail-closed controller for v41 role-complete carrier formal training."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_role_complete_carrier_formal_base",
    _BASE_PATH,
)
...
LOCK = OUTPUT.parent.parent / (
    ".formal_confidence_adapter_candidate_role_complete_carrier.lock"
)
