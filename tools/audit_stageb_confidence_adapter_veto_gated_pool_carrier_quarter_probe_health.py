...
"""Audit U300 health for quarter-carrier word-veto confidence."""
...
from tools import run_stageb_confidence_adapter_veto_gated_pool_carrier_quarter_probe as probe  # noqa: E402


_BASE_PATH = REPO_ROOT / "tools/audit_stageb_confidence_adapter_veto_gate_probe_health.py"
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_carrier_quarter_health_base", _BASE_PATH
)
...
SCHEMA = "pivot.stageb.confidence_adapter_veto_gated_pool_probe_health/v8"
_FIELDS = (
