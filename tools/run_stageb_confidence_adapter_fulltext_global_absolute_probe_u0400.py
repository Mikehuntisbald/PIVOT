...
"""Run the fresh U400 V53 fulltext global-absolute confidence probe."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_fulltext_global_absolute_u0400_base",
    _BASE_PATH,
)
...
LOCK = OUTPUT.parent.parent / ".confidence_adapter_fulltext_global_absolute_u0400.lock"
