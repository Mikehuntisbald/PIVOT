...
"""Run, audit, and promote the v39 U400 zero-offset strict1607 probe."""
...
from tools import (  # noqa: E402
    run_stageb_confidence_adapter_candidate_gate_zero_offset_probe_u0400 as training,
)

_BASE_PATH = REPO_ROOT / "tools/run_stageb_confidence_adapter_veto_probe_evaluation.py"
_BASE_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_candidate_gate_zero_offset_probe_evaluation_base",
    _BASE_PATH,
)
...
_HEALTH_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_candidate_gate_zero_offset_probe_health",
    _HEALTH_PATH,
)
