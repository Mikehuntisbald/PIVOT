...
"""Run the U300 floor-gated monotone tail-veto confidence screen."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_floor_gated_monotone_tail_veto_u0300_base",
    _BASE_PATH,
)
...
CONFIG = REPO_ROOT / (
    ...
    "floor_gated_monotone_tail_veto_probe_u0300_20260731.py"
)
OUTPUT = REPO_ROOT / (
...
LOCK = OUTPUT.parent.parent / (
    ".confidence_adapter_floor_gated_monotone_tail_veto_u0300.lock"
)
