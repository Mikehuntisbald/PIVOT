...
"""Run the fresh U400 candidate-complete depth-coverage C1 probe."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_candidate_complete_trace_c1_u0400_base",
    _BASE_PATH,
)
...
OUTPUT = REPO_ROOT / (
    ...
    "dense_duty_candidate_complete_trace_20260803/c1_free_head_coverage/"
    "probe/u000400_fresh"
)
CHECKPOINT = OUTPUT / "checkpoint_iter.pth"
LOCK = OUTPUT.parent.parent / ".candidate_complete_trace_c1_u0400.lock"
