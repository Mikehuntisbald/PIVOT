...
"""Run the independent U50 signed rank-query confidence-pool screen."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_signed_rank_pool_u0050_base", _BASE_PATH
)
...
OUTPUT = REPO_ROOT / (
    ...
    "highmem_20260731/probe/u000050"
)
CHECKPOINT = OUTPUT / "checkpoint_iter.pth"
LOCK = OUTPUT.parent.parent / ".confidence_adapter_signed_rank_pool_u0050.lock"
