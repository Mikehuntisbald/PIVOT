...
"""Run the fresh U400 v42 TN-only carrier-pair admission probe."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_candidate_tn_only_pair_u0400_base",
    _BASE_PATH,
)
...
LOCK = OUTPUT.parent.parent / (
    ".confidence_adapter_candidate_tn_only_carrier_pair_u0400.lock"
)
