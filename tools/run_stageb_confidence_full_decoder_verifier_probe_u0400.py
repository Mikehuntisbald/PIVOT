...
"""Run the fresh U400 full-decoder confidence-verifier capacity probe."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_full_decoder_verifier_u0400_base",
    _BASE_PATH,
)
...
LOCK = OUTPUT.parent.parent / ".full_decoder_verifier_u0400.lock"
