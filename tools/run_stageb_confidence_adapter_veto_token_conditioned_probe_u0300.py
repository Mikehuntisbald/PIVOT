...
"""Run the complete U300 token-conditioned monotone confidence screen."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_token_conditioned_u0300_base",
    _BASE_PATH,
)
...
CONFIG = REPO_ROOT / (
    ...
    "token_conditioned_probe_u0300_20260731.py"
)
OUTPUT = REPO_ROOT / (
    "outputs/paper_cvpr_v1/"
    "dense_duty_adapter_veto_token_conditioned_highmem_20260731/"
    "probe/u000300_attempt2"
)
CHECKPOINT = OUTPUT / "checkpoint_iter.pth"
LOCK = OUTPUT.parent.parent / ".confidence_adapter_token_conditioned_u0300.lock"
