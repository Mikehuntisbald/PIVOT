...
"""Fail-closed mechanical health audit for the V50 terminal U400 probe."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_split_strong_boundary_routing_probe_health_base", _BASE_PATH
)
...
TRAINING_CONTRACT_SCHEMA = "pivot.stageb.dense_duty_training_contract/v32"
...
EXPECTED_CONFIG_ENTRY = (
    ...
    "split_strong_boundary_routing_probe_u0400_20260801.py"
)
...
_CORE._default_output = lambda: Path(training.OUTPUT).parent / (
    "u000400_split_strong_boundary_routing_health_audit.json"
)
