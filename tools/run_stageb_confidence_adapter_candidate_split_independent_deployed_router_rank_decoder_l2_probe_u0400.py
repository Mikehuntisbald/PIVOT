...
"""Run the fresh U400 V51-L2 rank-decoder adaptation probe."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_v51_rank_decoder_l2_u0400_base",
    _BASE_PATH,
)
...
OUTPUT = REPO_ROOT / (
    ...
    "decoder_l2_20260813/probe/u000400_fresh"
)
CHECKPOINT = OUTPUT / "checkpoint_iter.pth"
LOCK = OUTPUT.parent.parent / ".v51_rank_decoder_l2_u0400.lock"
