...
"""Fail-closed controller for the word-veto confidence-adapter formal run."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_veto_base", _BASE_PATH
)
...
OUTPUT = (
    ...
    "dense_duty_adapter_veto_highmem_20260730/formal/confidence"
)
CHECKPOINT = OUTPUT / "checkpoint_iter.pth"
LOCK = OUTPUT.parent.parent / ".formal_confidence_adapter_veto.lock"
