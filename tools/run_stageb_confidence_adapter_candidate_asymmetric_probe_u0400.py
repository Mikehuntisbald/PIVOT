...
"""Run the fresh U400 v32 raw-patch asymmetric-veto admission probe."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_candidate_asymmetric_u0400_base",
    _BASE_PATH,
)
...
CONFIG = REPO_ROOT / (
    ...
    "candidate_asymmetric_probe_u0400_20260731.py"
)
OUTPUT = REPO_ROOT / (
...
LOCK = OUTPUT.parent.parent / ".confidence_adapter_candidate_asymmetric_u0400.lock"
