...
"""Fail-closed controller for the v4 absolute-cap confidence formal run."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_veto_cap_formal_base", _BASE_PATH
)
...
CONFIG = (
    REPO_ROOT
    / "config/ablations/"
    "cfg_stageb_dense_duty_confidence_adapter_veto_cap_20260731.py"
)
OUTPUT = (
    REPO_ROOT
    / "outputs/paper_cvpr_v1/"
    "dense_duty_adapter_veto_cap_highmem_20260731/formal/confidence"
)
CHECKPOINT = OUTPUT / "checkpoint_iter.pth"
LOCK = OUTPUT.parent.parent / ".formal_confidence_adapter_veto_cap.lock"
