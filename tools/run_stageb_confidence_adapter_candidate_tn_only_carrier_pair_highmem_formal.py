...
"""Fail-closed controller for v42 TN-only carrier-pair formal training."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_tn_only_pair_formal_base",
    _BASE_PATH,
)
...
LOCK = OUTPUT.parent.parent / (
    ".formal_confidence_adapter_candidate_tn_only_carrier_pair.lock"
)
