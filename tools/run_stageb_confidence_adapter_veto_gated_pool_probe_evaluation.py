...
"""Run and audit the v5 carrier-gated U300 strict1607 diagnostic."""
...
from tools import audit_stageb_confidence_adapter_veto_gated_pool_probe_health as health  # noqa: E402
from tools import run_stageb_confidence_adapter_veto_gated_pool_probe as training  # noqa: E402


_BASE_PATH = REPO_ROOT / "tools/run_stageb_confidence_adapter_veto_probe_evaluation.py"
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_veto_gated_pool_evaluation_base", _BASE_PATH
)
...
SCHEMA = "pivot.stageb.confidence_adapter_veto_gated_pool_probe_evaluation/v5"
POSTFLIGHT_SCHEMA = "pivot.stageb.confidence_adapter_veto_gated_pool_probe_evaluation_postflight/v5"
ADMISSION_SCHEMA = "pivot.stageb.confidence_adapter_veto_gated_pool_formal_admission/v5"
HEALTH_SCHEMA = health.SCHEMA
CONFIG = REPO_ROOT / "config/ablations/cfg_stageb_dense_duty_confidence_adapter_veto_gated_pool_probe_20260731.py"
FORMAL_CONFIG = REPO_ROOT / "config/ablations/cfg_stageb_dense_duty_confidence_adapter_veto_gated_pool_20260731.py"
CHECKPOINT = REPO_ROOT / "outputs/paper_cvpr_v1/dense_duty_adapter_veto_gated_pool_highmem_20260731/probe/u000300/checkpoint_iter.pth"
OUTPUT = REPO_ROOT / "outputs/paper_cvpr_v1/dense_duty_adapter_veto_gated_pool_highmem_20260731/probe_evaluation/u000300_strict1607"
