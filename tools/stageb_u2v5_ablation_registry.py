...
ROWS = (
    ...
    Row("A4", "A", "admission", "config/ablations/cfg_stageb_u2v5_ablation_a4_no_category_complete.py", "config/datasets_stageb_u2_category_complete_three_ref.json", 100, 56, "clean_initializer", ("surface8", "auxiliary8"), ("stage_b_u2_category_loss_weight",)),
    ...
    Row("C1", "C", "confidence", "config/ablations/cfg_stageb_u2v5_ablation_c1_current_batch.py", "config/datasets_stageb_u2v5_clean_confidence_d3.json", 50, 8, "A5", ("confidence12",), ("stage_b_gdino_queue_size", "stage_b_gdino_queue_min_count", "stage_b_gdino_positive_trust_weight")),
