...
"""Run the fresh U400 split-head FPR active-set confidence probe."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_candidate_split_fpr_active_set_u0400_base",
    _BASE_PATH,
)
...
LOCK = OUTPUT.parent.parent / ".confidence_adapter_split_fpr_active_set_u0400.lock"
