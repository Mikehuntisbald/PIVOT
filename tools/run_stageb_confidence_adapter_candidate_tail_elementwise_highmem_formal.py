...
"""Fail-closed controller for v38 elementwise-bounded-tail formal training."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_candidate_tail_elementwise_formal_base",
    _BASE_PATH,
)
...
LOCK = OUTPUT.parent.parent / ".formal_confidence_adapter_candidate_tail_elementwise.lock"
