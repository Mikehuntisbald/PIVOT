...
"""Fail-closed controller for v39 zero-offset lexical-gate formal training."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_candidate_gate_zero_offset_formal_base",
    _BASE_PATH,
)
...
LOCK = OUTPUT.parent.parent / (
    ".formal_confidence_adapter_candidate_gate_zero_offset.lock"
)
