...
"""Fail-closed controller for paired-carrier formal confidence training."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_carrier_pair_formal_base", _BASE_PATH
)
...
CONFIG = REPO_ROOT / "config/ablations/cfg_stageb_dense_duty_confidence_adapter_veto_gated_pool_carrier_pair_20260731.py"
OUTPUT = REPO_ROOT / "outputs/paper_cvpr_v1/dense_duty_adapter_veto_gated_pool_carrier_pair_highmem_20260731/formal/confidence"
CHECKPOINT = OUTPUT / "checkpoint_iter.pth"
LOCK = OUTPUT.parent.parent / ".formal_confidence_adapter_carrier_pair.lock"
...
def verify_probe_admission():
    from tools import run_stageb_confidence_adapter_veto_gated_pool_carrier_pair_probe_evaluation as promotion
