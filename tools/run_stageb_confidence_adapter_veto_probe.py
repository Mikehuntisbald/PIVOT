...
"""Run a fresh U300 word-veto confidence trajectory probe."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_veto_probe_base", _BASE_PATH
)
...
OUTPUT = (
    ...
    "dense_duty_adapter_veto_highmem_20260730/probe/u000300"
)
CHECKPOINT = OUTPUT / "checkpoint_iter.pth"
LOCK = OUTPUT.parent.parent / ".confidence_adapter_veto_probe.lock"
