...
"""Fail-closed controller for the v3 word-veto confidence formal run."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_veto_gate_formal_base", _BASE_PATH
)
...
OUTPUT = (
    ...
    "dense_duty_adapter_veto_gate_highmem_20260731/formal/confidence"
)
CHECKPOINT = OUTPUT / "checkpoint_iter.pth"
LOCK = OUTPUT.parent.parent / ".formal_confidence_adapter_veto_gate.lock"
