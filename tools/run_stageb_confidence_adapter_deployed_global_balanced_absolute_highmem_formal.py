...
"""Run fresh V57 formal confidence training after strict1607 admission."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_deployed_global_balanced_absolute_formal_base",
    _BASE_PATH,
)
...
LOCK = OUTPUT.parent.parent / (
    ".formal_confidence_adapter_deployed_global_balanced_absolute.lock"
)
