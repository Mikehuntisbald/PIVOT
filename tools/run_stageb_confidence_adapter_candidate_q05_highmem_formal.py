...
"""Fail-closed controller for v34 exact-q05 formal confidence training."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_candidate_q05_formal_base",
    _BASE_PATH,
)
...
OUTPUT = REPO_ROOT / (
    ...
    "dense_duty_adapter_candidate_q05_highmem_20260801/formal/confidence"
)
CHECKPOINT = OUTPUT / "checkpoint_iter.pth"
LOCK = OUTPUT.parent.parent / ".formal_confidence_adapter_candidate_q05.lock"
