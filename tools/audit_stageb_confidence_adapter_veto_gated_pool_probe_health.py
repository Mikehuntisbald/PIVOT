...
"""Audit U300 health for the v5 carrier-gated absolute cap."""
...
from tools import run_stageb_confidence_adapter_veto_gated_pool_probe as probe  # noqa: E402


_BASE_PATH = REPO_ROOT / "tools/audit_stageb_confidence_adapter_veto_gate_probe_health.py"
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_veto_gated_pool_health_base", _BASE_PATH
)
...
SCHEMA = "pivot.stageb.confidence_adapter_veto_gated_pool_probe_health/v5"
_GATED_POOL_FIELDS = (
