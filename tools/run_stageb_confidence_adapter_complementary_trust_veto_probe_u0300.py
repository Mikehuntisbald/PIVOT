...
"""Run the U300 complementary trust-veto confidence screen."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_complementary_trust_veto_u0300_base",
    _BASE_PATH,
)
...
CONFIG = REPO_ROOT / (
    ...
    "complementary_trust_veto_probe_u0300_20260731.py"
)
OUTPUT = REPO_ROOT / (
...
LOCK = OUTPUT.parent.parent / ".confidence_adapter_complementary_trust_veto_u0300.lock"
