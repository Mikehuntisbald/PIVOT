...
"""Run the U300 rank-affine word-veto confidence probe."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_rank_affine_probe_base", _BASE_PATH
)
...
CONFIG = REPO_ROOT / "config/ablations/cfg_stageb_dense_duty_confidence_adapter_veto_gated_pool_rank_affine_probe_20260731.py"
OUTPUT = REPO_ROOT / "outputs/paper_cvpr_v1/dense_duty_adapter_veto_gated_pool_rank_affine_highmem_20260731/probe/u000300"
CHECKPOINT = OUTPUT / "checkpoint_iter.pth"
LOCK = OUTPUT.parent.parent / ".confidence_adapter_rank_affine_probe.lock"
