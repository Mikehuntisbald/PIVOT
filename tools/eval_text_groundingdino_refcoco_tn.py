    ...
    if bool(getattr(cfg, "stage_b_u2v4_checkpoint_eval", False)):
        ...
        if bool(getattr(cfg, "stage_b_u2v4_legacy_admission_replay", False)):
            ...
            validate_runtime_payload(
                ...
                checkpoint_payload,
                checkpoint_label=(
                    f"U2-v4 surface replay evaluation checkpoint {checkpoint}"
                ),
            )
        elif bool(
            getattr(cfg, "stage_b_u2v4_legacy_training_replay", False)
        ):
            ...
            validate_runtime_payload(
                ...
                checkpoint_payload,
                checkpoint_label=(
                    f"U2-v4 training replay evaluation checkpoint {checkpoint}"
                ),
                initializer_path=Path(
                    str(getattr(cfg, "stage_b_u2v2_initializer_path"))
                ),
            ...
            raise RuntimeError("U2-v4 checkpoint eval has no replay owner")
    if bool(
