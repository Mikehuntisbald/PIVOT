...
"""Run the fresh U400 monotone token-entailment C2 probe."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_candidate_complete_trace_c2_u0400_base",
    _BASE_PATH,
)
...
OUTPUT = REPO_ROOT / (
    ...
    "dense_duty_candidate_complete_trace_20260803/"
    "c2_monotone_token_entailment/probe/u000400_fresh"
)
CHECKPOINT = OUTPUT / "checkpoint_iter.pth"
LOCK = OUTPUT.parent.parent / ".candidate_complete_trace_c2_u0400.lock"
