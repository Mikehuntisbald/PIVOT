...
"""Run the independent U50 continuous conditional-residual confidence screen."""
...
_SPEC = importlib.util.spec_from_file_location(
    "_pivot_stageb_confidence_adapter_continuous_residual_u0050_base",
    _BASE_PATH,
)
...
CONFIG = REPO_ROOT / (
    "config/ablations/"
    "cfg_stageb_dense_duty_confidence_adapter_veto_"
    "continuous_residual_probe_u0050_20260731.py"
)
OUTPUT = REPO_ROOT / (
    "outputs/paper_cvpr_v1/"
    "dense_duty_adapter_veto_continuous_residual_highmem_20260731/"
    "probe/u000050_attempt2"
)
CHECKPOINT = OUTPUT / "checkpoint_iter.pth"
LOCK = OUTPUT.parent.parent / ".confidence_adapter_continuous_residual_u0050.lock"
