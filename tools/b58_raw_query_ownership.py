#!/usr/bin/env python3
"""Contract for replaying the mature 100k raw-query owners on B58."""
...
ROOT = _REPO_ROOT
TRUNK_ID = "b58_raw_query"
EXPERIMENT_ROOT = ROOT / "outputs/b58_raw_query_ownership_20260822"
PREREGISTRATION = ROOT / "paper/data/b58_raw_query_ownership_preregistration.json"
...
EVAL_CONFIG = ROOT / "config/ablations/cfg_b58_raw_query_ownership_eval.py"
EVAL_CONFIG_SHA256 = (
    "9dd4064085c4aa8fc58d20c2abb7e1a9c0124961b187ec87c6b87a201277734e"
)
...
TEST5_SURFACES = tuple(name for name, spec in REF_INPUTS.items() if spec["test5"])
TESTAB_SURFACES = tuple(name for name, spec in REF_INPUTS.items() if spec["testab"])

PARENT_RESULT = ROOT / "paper/data/original_gdino_parent_ownership_results.json"
PARENT_AGGREGATE = (
    ROOT / "outputs/original_gdino_parent_ownership_20260822/aggregate.json"
)
PARENT_EVALUATION_ROOT = (
    ROOT / "outputs/original_gdino_parent_ownership_20260822/evaluation"
)
E5_REFERENCE = ROOT / "paper/data/mmgdino_e5_ownership_results.json"
B58_CAPACITY_REFERENCE = ROOT / "paper/data/b58_capacity_control_results.json"


@dataclass(frozen=True)
class TrunkSpec:
    trunk_id: str = TRUNK_ID
    display_name: str = "B58 mixed-Stage-B pure GroundingDINO-T"
    checkpoint: Path = CHECKPOINT
    checkpoint_sha256: str = CHECKPOINT_SHA256

    @property
    def model_id(self) -> str:
        return f"groundingdino-t-b58-{self.checkpoint_sha256[:8]}"
    ...
    def as_dict(self) -> dict[str, Any]:
        return {
            ...
            "training_surface": (
                "mixed Stage-B continuation from the direct parent using "
                "LVIS+COCO+RefCOCO++RefCOCOg+TN"
            ),
        }
...
__all__ = [
    "BOOTSTRAP_REPLICATES", "BOOTSTRAP_SEED", "B58_CAPACITY_REFERENCE",
    "CHECKPOINT", "CHECKPOINT_SHA256", "E5_REFERENCE", "EVAL_CONFIG",
    "EVAL_CONFIG_SHA256", "EXPERIMENT_ROOT", "FORMAL_SEEDS", "IMAGE_ROOT",
    "OWNERS", "PARENT_AGGREGATE", "PARENT_CHECKPOINT",
    "PARENT_CHECKPOINT_SHA256", "PARENT_EVALUATION_ROOT", "PARENT_RESULT",
    "PARENT_TO_B58_CHANGED_TENSORS", "PARENT_TO_B58_UNCHANGED_TENSORS",
    "PREREGISTRATION", "PURE_TRUNK_NUMEL", "PURE_TRUNK_SCHEMA_SHA256",
    "PURE_TRUNK_TENSORS", "REC_NONINFERIORITY_MARGIN", "REF_INPUTS", "ROOT",
    "SCHEDULE_RECEIPT", "SCHEDULE_ROOT", "TEST5_SURFACES",
    "TESTAB_SURFACES", "TRUNK_ID", "TRUNK_SPECS", "eval_cache_path",
    "eval_cache_receipt_path", "evaluation_output_dir",
    "owner_checkpoint_path", "owner_output_dir", "schedule_path",
    "training_cache_path", "training_cache_receipt_path",
]
