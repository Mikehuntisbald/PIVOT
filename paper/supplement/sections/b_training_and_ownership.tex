...
non-inferiority, while the rejection interval crosses zero.  The parent and
frozen-base checkpoints share the effective 938-tensor architecture, but the
ownership heads differ (100k raw-query versus 84k integrated).  We therefore
report a representation-stage trend rather than a same-head causal effect of
mixed Stage-B adaptation.
