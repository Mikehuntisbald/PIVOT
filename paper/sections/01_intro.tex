...
image; \arrown is a category-agnostic mechanism control.  The sealed
visual-support model is \textbf{ARROW-U2}; \arrowv names its Admission interface.
The category cue is
...
\begin{enumerate}[leftmargin=*,itemsep=1pt,topsep=2pt]
  ...
  show that, in ARROW-U2, separate outputs sharing a trainable feature owner
  are insufficient, whereas structural cross-duty isolation preserves
  localization and improves rejection.  A strong-trunk capacity control
  identifies where that optimization advantage no longer transfers.
