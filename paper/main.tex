...
isolation recovers 5.31 localization points on one frozen representation. With
identical 100k heads, it loses 2.00 points on a direct GroundingDINO parent but
only 0.05 after mixed-supervision adaptation; the rejection shift remains
unresolved despite negative-gradient tails.  A
